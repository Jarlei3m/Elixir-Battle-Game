defmodule ExMon.Game.Actions.Attack do
  ...
  defp update_opponent_life(remaining_life, opponent, damage) do
    opponent
    |> Game.fetch_player()
    |> Map.put(:life, remaining_life)
    |> update_game(opponent, damage)
  end

  defp update_game(damaged_opponent, opponent, damage) do
    Game.info()
    |> Map.put(opponent, damaged_opponent)
    |> Game.update()
